...
const withdrawalData: WithdrawalData | null = {
  message: "Withdrawal masih pending silahkan tunggu perusahaan mengirim uang kepada anda",
...
export const MyWalletWithDrawalStatus = () => {
  if (!withdrawalData) {
    return (
  ...
  const { message, requestedAt, amount, insurance, paymentStatus, bank, paymentMethod, paymentProof } = withdrawalData;
