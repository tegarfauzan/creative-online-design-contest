...
type SubmissionWinner = {
  ...
  prize: number;
  finalStatus: "Eliminated" | "In Review" | string;
  description: string;
...
export const SubmissionDetailsEliminated = () => {
  ...
  const data: SubmissionWinner = {
    ...
    description: "We are looking at redesigning the existing cover pages for the field service reports we submit to Customers. The same cover is utilized for different types of reports, so the Title and Subtitle lines. We are looking at redesigning the existing cover pages for the field service reports we submit to Customers.",
